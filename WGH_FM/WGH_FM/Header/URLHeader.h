...
#define WGH_OneRecommendAlbumWithIDURL  @"http://mobile.ximalaya.com/mobile/others/ca/album/track/%d/true/1/20?device=iPhone"   // 拼接id
...
// 具体某个类名下
#define WGH_OneTagNameURL @"http://mobile.ximalaya.com/mobile/discovery/v1/category/album?calcDimension=hot&categoryId=%d&device=iPhone&pageId=1&pageSize=20&status=0&tagName=%@"  //拼接(tagName) 需要转码 在根据pageid 刷新数据
...
#define WGH_OneHotListURL "http://mobile.ximalaya.com/mobile/discovery/v1/rankingList/track?device=iPhone&key=%@&pageId=1&pageSize=20"   // key  转码
