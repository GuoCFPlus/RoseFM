...
- (void)viewDidLoad {
    ...
    WGHUserMainViewController *userVC = [[WGHUserMainViewController alloc] init];
    [self addChildVc:userVC title:@"我的" image:[UIImage imageNamed:@"wgh_tabbar_user×32"] selectedImage:[UIImage imageNamed:@"wgh_tabbar_user×32_1"]];
    
    
    WGHTabBar *tabBar = [[WGHTabBar alloc] init];
    
    tabBar.translucent = NO;
    tabBar.tintColor = [UIColor colorWithRed:1.000 green:0.304 blue:0.156 alpha:1.000];
...
//    nav.navigationBar.titleTextAttributes =  [NSDictionary dictionaryWithObject:[UIColor colorWithRed:1.000 green:0.304 blue:0.156 alpha:1.000] forKey:UITextAttributeTextColor];
