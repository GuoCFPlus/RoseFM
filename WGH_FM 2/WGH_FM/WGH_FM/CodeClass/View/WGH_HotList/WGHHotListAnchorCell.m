...
{
    if (_hotDetailsModel !=hotDetailsModel) {
        _hotDetailsModel = nil;
        _hotDetailsModel = hotDetailsModel;
    }
    [self.leftImgView sd_setImageWithURL:[NSURL URLWithString:hotDetailsModel.middleLogo]];
    self.nameLabel.text = hotDetailsModel.nickname;
    ...
    self.introLabel.text = hotDetailsModel.personDescribe;
    self.friendLabel.text = [NSString stringWithFormat:@"%@万",hotDetailsModel.tracksCounts];
