...
- (void)requestMainData {
    ...
    [[WGHRequestData shareRequestData] requestAlbumListDataWithURL:[NSString stringWithFormat:WGH_OneRecommendAlbumWithIDURL,[self.showListModel.ID intValue],self.pageId] block:^(NSMutableArray *array, NSMutableDictionary *dictionary) {
