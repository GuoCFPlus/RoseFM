...
#define kLineWidth (kScreenWidth-kGap_20)/3
#define kImgWidth (kScreenWidth)/3-kGap_40
...
-(void)drawView{
    ...
    self.picPathImgView = [[UIImageView alloc]initWithFrame:CGRectMake(kGap_20, kGap_10, kImgWidth, kImgWidth)];
    ...
    self.rnameLabel = [[UILabel alloc]initWithFrame:CGRectMake(5, CGRectGetMaxY(self.picPathImgView.frame)+kGap_10, kLineWidth, kLineHeight)];
