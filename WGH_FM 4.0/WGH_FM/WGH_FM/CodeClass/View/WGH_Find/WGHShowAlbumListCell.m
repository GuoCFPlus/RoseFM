...
- (void)setup_subViews {
    ...
    self.playtimesLabel = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(playCounts.frame)+5, CGRectGetMaxY(self.titleLabel.frame)+5, 45, 15)];
    ...
    self.downButton = [[UIButton alloc] initWithFrame:CGRectMake(kScreenWidth-kGap_40, 45, kGap_30, kGap_30)];
    [self.downButton setImage:[UIImage imageNamed:@"wgh_album_download"] forState:UIControlStateNormal];
