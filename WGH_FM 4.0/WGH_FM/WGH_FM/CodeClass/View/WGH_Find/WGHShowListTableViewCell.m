...
- (void)setShowListModel:(WGHShowListModel *)showListModel {
    ...
    [self.leftImgView sd_setImageWithURL:[NSURL URLWithString:showListModel.coverMiddle] placeholderImage:[UIImage imageNamed:@"placeholder"]];
    ...
    self.tracksCountsLabel.text = [NSString stringWithFormat:@"%d集",[showListModel.tracks intValue]];
