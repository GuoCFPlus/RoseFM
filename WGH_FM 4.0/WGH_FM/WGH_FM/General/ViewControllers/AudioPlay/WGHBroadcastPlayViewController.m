...
- (void)requestRecommendData {
    ...
    {
        url = [NSString stringWithFormat:@"http://live.ximalaya.com/live-web/v1/getProgramDetail?device=iPhone&programScheduleId=0&radioId=%@",self.playModel.radioId];
    }
...
-(void)viewDidAppear:(BOOL)animated{
    ...
    if ([[WGHLeanCloudTools sharedLeanUserTools] isLoggedIn]) {
        ...
        //插入其他电台
        [db insertBroadcastHistoryTop:self.playModel];
