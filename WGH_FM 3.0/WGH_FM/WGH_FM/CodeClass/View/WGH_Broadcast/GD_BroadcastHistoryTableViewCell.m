//
//  GD_BroadcastHistoryTableViewCell.m
//  WGH_FM
//
...
#import "GD_BroadcastHistoryTableViewCell.h"
...
@implementation GD_BroadcastHistoryTableViewCell
...
-(void)drawView{
    ...
    self.programNameLabel.text = @"上次收听：央广新闻";
    ...
    self.radioPlayCountLabel.text = @"收听时间：2分钟前";
