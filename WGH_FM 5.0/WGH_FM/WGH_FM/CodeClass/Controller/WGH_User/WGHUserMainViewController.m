...
- (void)viewDidLoad {
    ...
    recordBtn.titleLabel.font = [UIFont systemFontOfSize:17];
...
- (void)changedMyDownload {
    ...
    WGHDownLoadTableViewController *downVC = [WGHDownLoadTableViewController new];
    UINavigationController *downNC = [[UINavigationController alloc] initWithRootViewController:downVC];
    [downNC.navigationBar setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIColor colorWithRed:1.000 green:0.304 blue:0.156 alpha:1.000],UITextAttributeTextColor,[UIFont systemFontOfSize:18],UITextAttributeFont,nil]];
    downNC.navigationBar.tintColor = [UIColor colorWithRed:1.000 green:0.304 blue:0.156 alpha:1.000];
    [self presentViewController:downNC animated:YES completion:nil];
...
- (void)changedCollect {
    ...
    WGHCollectTableViewController *collectVC = [[WGHCollectTableViewController alloc] initWithStyle:UITableViewStyleGrouped];
    UINavigationController *collectNC = [[UINavigationController alloc] initWithRootViewController:collectVC];
    [collectNC.navigationBar setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIColor colorWithRed:1.000 green:0.304 blue:0.156 alpha:1.000],UITextAttributeTextColor,[UIFont systemFontOfSize:18],UITextAttributeFont,nil]];
    collectNC.navigationBar.tintColor = [UIColor colorWithRed:1.000 green:0.304 blue:0.156 alpha:1.000];
    collectNC.navigationBar.alpha = 0;
    [self presentViewController:collectNC animated:YES completion:nil];
